          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                  ...
                  <div class="flex items-center justify-between">
                      ...
                      <a href="#" class="text-sm font-medium text-primary-600 hover:underline dark:text-red-500">Forgot password?</a>
                  </div>
                  ...
                  <p className='text-white font-bold lg:ml-44'>OR</p>
                  <Googlelogin></Googlelogin>
                  <p class="text-sm font-light text-gray-500 lg:ml-24 dark:text-gray-400">
